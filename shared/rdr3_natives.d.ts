...
declare function CreateVarString(p0: number, p1: string, variadic: string): number;
...
declare function PromptSetEnabled(prompt: number, p1: boolean): void;
...
declare function PromptSetHoldMode(prompt: number, p1: boolean): void;
...
declare function PromptSetVisible(prompt: number, p1: boolean): void;
